...
def filter_content(content):
    ...
    keywords = ["㊙VIP测试", "关注公众号", "天微科技", "获取测试密码", "更新时间", "♥聚玩盒子", "🌹防失联","📡  更新日期","👉","请阅读","yuanzl77.github.io"]
...
def fetch_and_filter(urls):
    ...
    with open('ipv4.txt', 'w', encoding='utf-8') as file:
        file.write('\n'.join(valid_lines))
    logging.info("Filtered content saved to ipv4.txt")

if __name__ == "__main__":
    urls = [
        'https://raw.githubusercontent.com/ilxp/YKTV/main/live.txt',
